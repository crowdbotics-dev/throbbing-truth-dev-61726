...
## Project Structure
    ...
    ├── throbbing_truth_dev_61726  # Django project configurations
...
1. Clone this repo and `cd throbbing_truth_dev_61726`
...
2. Clone this repo and `cd throbbing_truth_dev_61726`
