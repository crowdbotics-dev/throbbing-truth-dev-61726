"""
Django settings for throbbing_truth_dev_61726 project.
...
ROOT_URLCONF = 'throbbing_truth_dev_61726.urls'
...
WSGI_APPLICATION = 'throbbing_truth_dev_61726.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "throbbing_truth_dev_61726 API",
    "DESCRIPTION": "API documentation for throbbing_truth_dev_61726 App",
    "VERSION": "v1",
}
